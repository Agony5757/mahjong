...
:mod:`pymahjong.rl` for the architectural rationale.
...
from pymahjong.rl.splits import split_by_game_id, split_by_shard, split_by_track_id
...
def main() -> int:
    ...
    model = DouzeroTransformer(event_dim=100, action_feat_dim=ACTION_FEAT_DIM, 
        config=tcfg,
