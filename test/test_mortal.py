...
from pymahjong.rl.grp import (
    GRP,
    GRP_SIZE,
    RewardCalculator,
    build_grp_feature,
)
from pymahjong.rl.mortal import MortalConfig, MortalTrainer
from pymahjong.rl.mortal_qnet import MortalQNet
...
def test_export_v5_ckpt_loads_into_douzero_v5_strict(tmp_path):
    ...
    ck = torch.load(exp)
    v5 = DouzeroTransformer(config=tcfg, scorer_hidden=32)
    # Exact key match: the bench loads this as a DouzeroTransformer.
